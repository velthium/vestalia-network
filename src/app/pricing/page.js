...
export default function Home() {
  ...
  return (
    <div className="container">
      ...
      <p style={{ color: 'var(--text-primary)' }}>Select the storage size and the duration of your plan</p>
      <div className="row">
        <div className="col-lg-6 mb-4">
          <div className="p-5 rounded shadow-sm h-100" style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--card-border)' }}>
            <div className="d-flex justify-content-evenly flex-wrap">
              <div className="form-group">
                <label htmlFor="size-input" className="form-label d-flex align-items-center gap-2" style={{ color: 'var(--text-primary)' }}><FaHdd size={32} color="#7B61FF" className="me-2" /> Enter Storage Size:</label>
              ...
              <div className="form-group">
                <label htmlFor="years-input" className="form-label d-flex align-items-center gap-2" style={{ color: 'var(--text-primary)' }}><FaClock size={32} color="#7B61FF" className="me-2" /> Enter Duration:</label>
            ...
            {estimatedUsd && estimatedJkl && <div className="text-center my-4" style={{ color: 'var(--text-primary)' }}><div>Estimated cost: <strong>{estimatedUsd} USD</strong></div><div>Approx. <strong>{estimatedJkl}</strong></div></div>}
        ...
        <div className="col-lg-6 mb-4">
          <div className="p-5 rounded shadow-sm text-center h-100" style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--card-border)' }}>
            <h3 className="mb-4" style={{ color: 'var(--text-primary)' }}>Need JKL tokens?</h3>
            <p className="mb-4" style={{ color: 'var(--text-primary)' }}>You can swap ATOM for JKL directly using the Leap Wallet interface below.</p>
